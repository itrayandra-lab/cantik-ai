...
@section('content')
    <div class="min-h-screen bg-gray-900 flex flex-col items-center justify-center relative px-4">
        ...
        <img src="{{ asset('assets/img/bot.gif') }}" alt="Coming Soon"
            class="w-48 h-48 z-10 ">

        <h1 class="text-5xl md:text-7xl text-white font-bold mb-4 z-10">Coming Soon</h1>
        ...
        <div class="z-10 flex flex-col sm:flex-row gap-3 sm:gap-6 items-center">
            <a href="https://wa.me/081234567890" target="_blank" rel="noopener noreferrer"
