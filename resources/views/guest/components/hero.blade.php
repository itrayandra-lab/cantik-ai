        ...
        <div class="flex items-center justify-between py-4 sm:py-6">
          <div class="flex items-center">
            ...
            <div class="hidden md:flex ml-10 space-x-8">
              <a href="https://lunaray.id/about-us/" class="text-gray-600 hover:text-gray-900 py-1">Tentang Kami</a>
              <a href="https://lunaray.id/services/" class="text-gray-600 hover:text-gray-900 py-1">Layanan</a>
              <a href="https://lunaray.id/contact-us/" class="text-gray-600 hover:text-gray-900 py-1">Kontak</a>
            </div>
          </div>
      ...
      <div class="mt-12 relative lg:mt-0 2xl:pr-8" >
        <div class="relative w-full max-w-md mx-auto">
            ...
            <div data-aos="fade-down"
                ...
                <div>
                    <p class="text-sm font-medium text-gray-900">Sarah Amalia</p>
                    <p class="text-xs text-gray-500">Kulitku tidak kusam lagi!</p>
                </div>
            </div>
            ...
            <div class=" absolute right-3/5  bg-white p-2 sm:p-3 rounded-full shadow-lg flex items-center space-x-2 whitespace-nowrap">
                ...
                <p class="text-xs text-gray-500 ">Hallo ada keluhan kulit ?</p>
            </div>
        </div>
      </div>
    </div>
